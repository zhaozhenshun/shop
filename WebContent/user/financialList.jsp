		    ...
		    success: function(data) {
		        if(data.status==1){
		        	...
		        	for(var i=0;i<list.length;i++){
		        		...
		        		$("#orderList").append("<div class='order-list' id='"+list[i].id+"'><a href='javascript:void(0)'><div class='cart-title wbox'><div class='of f30'>交易号&nbsp;&nbsp;"+list[i].no+"</div><div class='wbox-flex tr sn-txt-muted'>操作人 <i class='f30 sn-txt-black'> "+list[i].operator+" </i></div></div></a><ul class='order-pro-list order-box'><li id='"+list[i].id+"_'><a href='javascript:void(0)' class='pro-list'><div class='wbox'><div class='pro-info wbox-flex'><div class='pro-name text-clamp2 fs26'>"+list[i].remark+"</div><div class='snPrice sn-txt-black fs30'>&yen;"+list[i].money+"</div><div class='list-opra sn-txt-muted'>"+date+" "+type+"</div></div></div></a></li></ul></div>");
		        	}
