	...
	function moneyOnblur(){
  		...
  		if(!reg.test(money)){
  			...
  			if(money<=0){
	  			...
	  			if(money>balance){
	  				alertDefaultStyle("mini", "货币额度不足");
	  				$("#money").val("0");
	  			}
  			}
  		}
  	}
  	function balanceToUser(){
...
<body>
    <div class="sn-nav">
		...
		<div class="sn-nav-title of" id="addAddr">会员转账</div>
	...
	<section class="sn-main pr">
		...
		<div class="input-a sn-block wbox mt30 pr">
			...
			<div class="wbox-flex ml30 pr">
				<input type="text" id="userno" name="userno" maxlength="32" onblur="moneyOnblur()">
			</div>
			<em class="delete" style="display:none" name="Wap_reg_person_001"></em>
		</div>
		<div class="input-a sn-block wbox mt30 pr">
		...
		<a href="javascript:balanceToUser()" name="Wap_reg_person_005" class="first-step sn-btn sn-btn-big sn-btn-block m30 sn-btn-positive">转入</a>
	</section>
