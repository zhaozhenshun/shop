...
body {
    background: url(res/images/hansanlogo.png) no-repeat center center fixed;
...
<div class="main_box">
	...
	<div class="login_box">
        <div class="login_logo">
            <img src="res/images/hansanlogo.png" >
        </div>
	...
	<div class="bottom">Copyright &copy; 2012 - 2015 <a href="http://www.hansan.com" target="_blank">汉三网络</a> <a href="http://bbs.hansan.com" target="_blank">汉三网络论坛</a> <a href="http://www.919dns.com" target="_blank">919数据中心</a></div>
</div>
</body>
</html>