...
<div class="bjui-pageContent">
	<form action="productSave" method="post" class="pageForm" data-toggle="validate" data-reload-navtab="true">
        <div class="pageFormContent" data-layout-h="0">
	            ...
	            <table class="table table-condensed table-hover" width="100%">
	                <thead>
	                    <tr>
	                    	<td colspan="2" align="center"><h3>添加产品</h3></td>
	                    </tr>
	                </thead>
	                <tbody>
	                    <tr>
                    	...
                    	<td>
                            ...
                            <input type="hidden" name="product.picture" id="picture" data-rule="" size="30">
							...
							<span id="picture_span_pic"></span>
                        </td>
                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">标题：</label>
	                            <input type="text" name="product.title" id="title" data-rule="required" size="50" placeholder="请输入标题">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">面额：</label>
	                            <input type="text" name="product.bills" id="bills" data-rule="required;number" size="10" placeholder="请输入面额">元
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="title" class="control-label x90">售价：</label>
	                            <input type="text" name="product.money" id="money" data-rule="required;number" size="10" placeholder="请输入售价">元
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
