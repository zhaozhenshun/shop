<div class="bjui-pageContent">
    <form action="adminSave" method="post" class="pageForm" data-toggle="validate" data-reload-navtab="true">
        <div class="pageFormContent" data-layout-h="0">
            <table class="table table-condensed table-hover">
                <thead>
                    <tr>
                        <td colspan="2" align="center"><h3>添加管理员</h3></td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                    	<td>
                            ...
                            <input type="text" name="admin.name" id="name" data-rule="required" size="20">
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="j_dialog_name" class="control-label x90">密码：</label>
                            <input type="password" name="admin.password" id="password" data-rule="required" size="20">
                        </td>
                    </tr>
                    <tr>
                        <td>
