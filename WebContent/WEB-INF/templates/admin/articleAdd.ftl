...
<div class="bjui-pageContent">
	<form action="articleSave" method="post" class="pageForm" data-toggle="validate" data-reload-navtab="true">
	            ...
	            <table class="table table-condensed table-hover" width="100%">
	                ...
	                <tbody>
	                    <tr>
		                       ...
		                       <input type="hidden" name="article.articleCate.id" id="fatherId2" value="0">
	                    ...
	                    <tr>
	                        <td>
	                            ...
	                            <input type="text" name="article.title" id="title" data-rule="required" size="50" placeholder="请输入中文标题">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            ...
	                            <textarea name="article.summary" id="summary" class="j-content" data-rule="" style="width: 500px;height:100px;" ></textarea>
	                        	</div>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            ...
	                            data-toggle="kindeditor" data-minheight="200" data-upload-json="../res/bjui/plugins/kindeditor_4.1.10/jsp/upload_json.jsp" 
	                             data-file-manager-json="../res/bjui/plugins/kindeditor_4.1.10/jsp/file_manager_json.jsp"></textarea>
	                        	</div>
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            ...
	                            <input type="text" name="article.views" id="views" data-rule="required number" size="20" placeholder="请输入点击数" value="0">
	                        </td>
	                    </tr>
	                    <tr>
	                        <td>
	                            <label for="status" class="control-label x90">状态：</label>
	                            <select name="article.status" id="status" data-style="btn-default btn-sel" data-width="auto">
