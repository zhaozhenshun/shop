...
<html>
<head>
<title>${product.title!""}-${config.siteEnName!""}</title>
<!-- Bootstrap -->
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">${product.enTitle!""}</h3>
		<ol class="breadcrumb pull-right">
		  <li><a href="../">Home</a></li>
		  <li class="active"><a href="list.do?id=${product.productCate.id}">${product.productCate.enName}</a></li>
		</ol>
		<div class="clearfix"></div>
	</div>
</div>
