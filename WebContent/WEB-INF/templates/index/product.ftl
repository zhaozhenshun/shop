...
<html>
<head>
<title>${product.title!""}-${config.siteName!""}</title>
<!-- Bootstrap -->
...
<div class="container">
	<div class="main_grid1">
		<h3 class="style pull-left">${product.title!""}</h3>
		<ol class="breadcrumb pull-right">
		  <li><a href="../">首页</a></li>
		  <li class="active"><a href="list.do?id=${product.productCate.id}">${product.productCate.name}</a></li>
		</ol>
		<div class="clearfix"></div>
	</div>
</div>
